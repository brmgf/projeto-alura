...
public class ValidationExceptionHandler {
    ...
    public ResponseEntity<Object> handleRuntimeException(RuntimeException ex, WebRequest request) {
        ErrorItemDTO errorItemDTO = new ErrorItemDTO(ex.getMessage(), request.getDescription(false));
        return new ResponseEntity<>(errorItemDTO, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}